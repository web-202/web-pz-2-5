...
document.getElementById('dark-scheme').addEventListener('click', () => {
    document.querySelector('.calculator').classList.remove('light-scheme');
    document.querySelector('.calculator').classList.add('dark-scheme');
});

document.getElementById('light-scheme').addEventListener('click', () => {
    document.querySelector('.calculator').classList.remove('dark-scheme');
    document.querySelector('.calculator').classList.add('light-scheme');
});
